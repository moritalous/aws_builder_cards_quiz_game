...
const awsServicesString = awsServices.join(", ");
...
5. If the user asks for "next question", "another one", or similar phrases, provide a new random AWS service description from the list provided.
